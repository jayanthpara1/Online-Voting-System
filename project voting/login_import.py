...
def login():
    ...
    try:
        ...
        if not matching_data.empty:
            ...
            open_voting_window()  # Open the voting window (function defined below)
        else:
...
def open_voting_window():
    # Create a new Tkinter window for the voting system
    voting_app = tk.Tk()
    voting_app.title("Voting System")
    import voting

    # Rest of your voting window initialization code...

    # Start the Tkinter main loop for the voting window
    voting_app.mainloop()
