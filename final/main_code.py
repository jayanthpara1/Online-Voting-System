...
def open_voting_window():
    ...
    def show_political_parties():
        ...
        parties ={
    "Andhra Pradesh": ["Telugu Desam Party (TDP)", "YSR Congress Party (YSRCP)", "Bharatiya Janata Party (BJP)", "Indian National Congress (INC)","NOTA"],
    "Arunachal Pradesh": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "National People's Party (NPP)", "Janata Dal (United) (JDU)","NOTA"],
    "Assam": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "All India United Democratic Front (AIUDF)", "Asom Gana Parishad (AGP)","NOTA"],
    "Bihar": ["Janata Dal (United) (JDU)", "Rashtriya Janata Dal (RJD)", "Bharatiya Janata Party (BJP)", "Indian National Congress (INC)","NOTA"],
    "Chhattisgarh": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Janata Congress Chhattisgarh (JCC)","NOTA"],
    "Goa": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Aam Aadmi Party (AAP)", "Maharashtrawadi Gomantak Party (MGP)","NOTA"],
    "Gujarat": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Aam Aadmi Party (AAP)","NOTA"],
    "Haryana": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Indian National Lok Dal (INLD)", "Jannayak Janta Party (JJP)","NOTA"],
    "Himachal Pradesh": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Aam Aadmi Party (AAP)","NOTA"],
    "Jharkhand": ["Bharatiya Janata Party (BJP)", "Jharkhand Mukti Morcha (JMM)", "Indian National Congress (INC)", "Rashtriya Janata Dal (RJD)","NOTA"],
    "Karnataka": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Janata Dal (Secular) (JDS)", "All India United Democratic Front (AIUDF)","NOTA"],
    "Kerala": ["Communist Party of India (Marxist) (CPI-M)", "Indian National Congress (INC)", "Bharatiya Janata Party (BJP)", "Communist Party of India (CPI)","NOTA"],
    "Madhya Pradesh": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Bahujan Samaj Party (BSP)", "Samajwadi Party (SP)","NOTA"],
    "Maharashtra": ["Shiv Sena", "Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Nationalist Congress Party (NCP)","NOTA"],
    "Manipur": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Naga People's Front (NPF)", "Janata Dal (United) (JDU)","NOTA"],
    "Meghalaya": ["Indian National Congress (INC)", "National People's Party (NPP)", "Bharatiya Janata Party (BJP)", "United Democratic Party (UDP)","NOTA"],
    "Mizoram": ["Mizo National Front (MNF)", "Indian National Congress (INC)", "Bharatiya Janata Party (BJP)", "Zoram People's Movement (ZPM)","NOTA"],
    "Nagaland": ["Naga People's Front (NPF)", "Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Nationalist Democratic Progressive Party (NDPP)","NOTA"],
    "Odisha": ["Biju Janata Dal (BJD)", "Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Communist Party of India (CPI)","NOTA"],
    "Punjab": ["Indian National Congress (INC)", "Shiromani Akali Dal (SAD)", "Aam Aadmi Party (AAP)", "Bharatiya Janata Party (BJP)","NOTA"],
    "Rajasthan": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Bahujan Samaj Party (BSP)", "Communist Party of India (Marxist) (CPI-M)","NOTA"],
    "Sikkim": ["Sikkim Democratic Front (SDF)", "Sikkim Krantikari Morcha (SKM)", "Bharatiya Janata Party (BJP)", "Indian National Congress (INC)","NOTA"],
    "Tamil Nadu": ["Dravida Munnetra Kazhagam (DMK)", "All India Anna Dravida Munnetra Kazhagam (AIADMK)", "Bharatiya Janata Party (BJP)", "Indian National Congress (INC)","NOTA"],
    "Telangana": ["Telangana Rashtra Samithi (TRS)", "Indian National Congress (INC)", "Bharatiya Janata Party (BJP)", "Telugu Desam Party (TDP)","NOTA"],
    "Tripura": ["Bharatiya Janata Party (BJP)", "Communist Party of India (Marxist) (CPI-M)", "Indigenous People's Front of Tripura (IPFT)", "Indian National Congress (INC)","NOTA"],
    "Uttar Pradesh": ["Bharatiya Janata Party (BJP)", "Samajwadi Party (SP)", "Bahujan Samaj Party (BSP)", "Indian National Congress (INC)","NOTA"],
    "Uttarakhand": ["Bharatiya Janata Party (BJP)", "Indian National Congress (INC)", "Aam Aadmi Party (AAP)","NOTA"],
    "West Bengal": ["All India Trinamool Congress (AITC)", "Bharatiya Janata Party (BJP)", "Communist Party of India (Marxist) (CPI-M)", "Indian National Congress (INC)","NOTA"]
    }
